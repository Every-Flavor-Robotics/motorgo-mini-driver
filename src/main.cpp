...
void setup()
{
  ...
  motorgo_mini->init_ch1(motor_params_ch0, false, false);
...
void loop()
{
  ...
  //   Print velocity of motor
  Serial.print("Velocity: ");
  Serial.print(motorgo_mini->get_ch0_velocity());
  Serial.print(" ");
  Serial.println(motorgo_mini->get_ch1_velocity());
  delay(50);
